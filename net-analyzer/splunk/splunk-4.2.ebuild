...
REL_URI="http://download.splunk.com/releases/${PV}/splunk"
#REL_URI="http://www.splunk.com/index.php/download_track?file=4.2/splunk/linux"
SRC_URI="x86? ( ${REL_URI}/linux/${P}-${MY_BUILD}-Linux-i686.tgz )
     amd64? ( ${REL_URI}/linux/${P}-${MY_BUILD}-Linux-x86_64.tgz )"
#SRC_URI="${REL_URI}/splunk-4.2-96430-Linux-x86_64.tgz&ac=&wget=true&name=wget&typed=releases"
LICENSE="splunk-eula"
SLOT="0"
KEYWORDS="-* ~x86 ~amd64"
IUSE=""
